    ...
    {/* Show recipe mode */}
      ...
      <div className='recipe-body'>
        ...
        <h1 className='recipe-title'>{recipe.title}</h1>
          ...
          <h5 className='username-heading-recipe'>This recipe is made with love by: <span className="recipe-author-recipe-page"onClick={()=>navigate("/profile/" + chef.username)}> @{chef.username}</span></h5>
          </div>
